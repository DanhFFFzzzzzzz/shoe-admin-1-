    ...
    <main className='grid flex-1 items-start gap-4 p-4 sm:px-6 sm:py-0 md:gap-8'>
      <div className='container mx-auto p-4'>
        <div className='flex justify-between items-center mb-8'>
          <h1 className='text-3xl font-extrabold text-center w-full tracking-tight text-zinc-800 dark:text-zinc-100'>Products Management</h1>
          <Button
            onClick={() => {
              setCurrentProduct(null);
              setIsProductModalOpen(true);
            }}
            className='ml-4 px-6 py-2 rounded-lg bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-semibold shadow-lg hover:from-blue-600 hover:to-indigo-700 transition-colors duration-200'
          >
            <PlusIcon className='mr-2 h-5 w-5' /> Add Product
          </Button>
        </div>

        <div className='overflow-x-auto rounded-2xl shadow-xl bg-white dark:bg-zinc-900/80 border border-zinc-200 dark:border-zinc-800'>
          <Table className='min-w-[900px]'>
            <TableHeader className='bg-zinc-100 dark:bg-zinc-800'>
              <TableRow>
                <TableHead className='py-3 px-4 text-zinc-700 dark:text-zinc-200 font-bold'>Title</TableHead>
                <TableHead className='py-3 px-4'>Category</TableHead>
                <TableHead className='py-3 px-4'>Price</TableHead>
                <TableHead className='py-3 px-4'>Max Quantity</TableHead>
                <TableHead className='py-3 px-4'>Description</TableHead>
                <TableHead className='py-3 px-4'>Sizes</TableHead>
                <TableHead className='py-3 px-4'>Hero Image</TableHead>
                <TableHead className='py-3 px-4'>Product Images</TableHead>
